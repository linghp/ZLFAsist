...
import com.cqvip.zlfassist.freshlistview.FreshListView.OnScrollListener;
import com.cqvip.zlfassist.freshlistview.FreshListView.OnScrollStateListener;
...
abstract class ZrcAbsListView extends ZrcAdapterView<ListAdapter> implements ViewTreeObserver.OnTouchModeChangeListener {
    ...
    boolean performLongPress(final View child, final int longPressPosition, final long longPressId) {
        ...
        if (mOnItemLongClickListener != null) {
            handled = mOnItemLongClickListener.onItemLongClick((FreshListView) this, child, longPressPosition,
                    longPressId);
        }
        if (handled) {
